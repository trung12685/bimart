...
//vnpay
Route::any('/vnpay-payment', 'VnpayController@payment')->name('vnpay-payment');
Route::any('/vnpay-response', 'VnpayController@callback_response')->name('vnpay-response');

//nganluong
Route::any('/nganluong-payment', 'NganluongController@payment')->name('nganluong-payment');
Route::any('/nganluong-response', 'NganluongController@callback_response')->name('nganluong-response');
Route::any('/nganluong-index', 'NganluongController@index')->name('nganluong-index');
