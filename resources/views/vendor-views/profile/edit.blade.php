        ...
        <div class="row">
                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:" id="generalSection">
                                    <i class="tio-user-outlined nav-icon"></i>{{translate('messages.information')}} {{translate('messages.basic')}}
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h2 class="card-title h4">{{translate('messages.information')}} {{translate('messages.Basic')}}</h2>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="customFileUpload">{{translate('messages.Upload')}} {{translate('messages.image')}}</label>
                                    </div>
                                </div>
                                </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title">{{translate('messages.Change')}} {{translate('messages.password')}}</h4>
                    </div>
