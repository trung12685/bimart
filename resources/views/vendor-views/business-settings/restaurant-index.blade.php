    ...
    <div class="content container-fluid config-inline-remove-class">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.setup')}} {{translate('messages.store')}}
                </span>
            </h1>
        </div>
        <!-- Page Heading -->
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <span>
                        {{translate('messages.settings')}} {{translate('messages.store')}}
                    </span>
                </h5>
            </div>
            <div class="card-body">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <span>
                        {{translate('messages.settings')}} {{translate('messages.basic')}}
                    </span>
                </h5>
            </div>
            <div class="card-body">
                <form action="{{route('vendor.business-settings.update-setup',[$store['id']])}}" method="post"
                    ...
                    <div class="row">
                        <div class="form-group mb-0 col-md-4">
                            <label class="input-label text-capitalize" for="title">{{translate('messages.amount')}} {{translate('messages.order')}} {{translate('messages.minimum')}}</label>
