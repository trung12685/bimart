    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.add')}} {{translate('messages.deliveryman')}}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="form-label m-0">{{translate('messages.image')}} {{translate('messages.identity')}}
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="form-label m-0">{{translate('messages.image')}} {{translate('messages.deliveryman')}}
