        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{translate('messages.update')}} {{translate('messages.coupon')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('vendor.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{translate('messages.date')}} {{translate('messages.start')}}</label>
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{translate('messages.date')}} {{translate('messages.expire')}}</label>
