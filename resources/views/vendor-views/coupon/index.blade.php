        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{translate('messages.add')}} {{translate('messages.coupon')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('vendor.coupon.store')}}" method="post">
                   ...
                   <div class="row">
                       ...
                       <div class="col-4">
                           <div class="form-group">
                               <label class="input-label" for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.coupon')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.date')}} {{translate('messages.start')}}</label>
                                <input type="date" name="start_date" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.date')}} {{translate('messages.expire')}}</label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.purchase')}} {{translate('messages.min')}}</label>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.discount')}} {{translate('messages.max')}}</label>
                        ...
                        <div class="col-md-2 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.discount')}}</label>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th>{{translate('messages.purchase')}} {{translate('messages.min')}}</th>
                                <th>{{translate('messages.discount')}} {{translate('messages.max')}}</th>
                                <th>{{translate('messages.discount')}}</th>
                                <th>{{translate('messages.type')}} {{translate('messages.discount')}}</th>
                                <th>{{translate('messages.date')}} {{translate('messages.start')}}</th>
                                <th>{{translate('messages.date')}} {{translate('messages.expire')}}</th>
