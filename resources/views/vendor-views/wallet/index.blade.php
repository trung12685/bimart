...
<div class="content container-fluid">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-sm-6">
                        <div class="resturant-card card--bg-2" >
                            ...
                            <div class="subtitle">{{translate('messages.withdraw')}} {{translate('messages.pending')}}</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom pb-3">
                    <h5 class="modal-title" id="exampleModalLabel">{{translate('messages.request')}} {{translate('messages.withdraw')}}</h5>
    ...
    <div class="card mt-3">
        <div class="card-header border-0">
            <h5 class="card-title">{{translate('messages.table')}} {{translate('messages.request')}} {{translate('messages.withdraw')}}</h5>
        </div>
