...
<div class="content container-fluid">
    ...
    <div class="d-sm-flex row align-items-center justify-content-between mb-2">
        <div class="col-md-6"> 
             <h4 class=" mb-0 text-black-50">{{translate('messages.information')}} {{translate('messages.seller')}} {{translate('messages.Withdraw')}}</h4>
            </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    {{translate('messages.info')}} {{translate('messages.Shop')}}
                </div>
                <div class="card-body">
    ...
    <div class="row mt-3" >
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    {{translate('messages.info')}} {{translate('messages.Seller')}}
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="h3 mb-0  ">{{translate('messages.information')}} {{translate('messages.Withdraw')}} </h3>
                </div>
                <div class="card-body">
