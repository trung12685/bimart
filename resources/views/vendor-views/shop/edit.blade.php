    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h2 class="page-header-title text-capitalize">
                ...
                <span>
                    {{translate('messages.edit')}} {{translate('messages.info')}} {{translate('messages.store')}}
                </span>
            </h1>
        </div>
            ...
            <div class="row g-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{translate('messages.name')}} {{translate('messages.store')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="name" value="{{$shop->name}}" class="form-control" id="name"
                                                required>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">{{translate('messages.number')}} {{translate('messages.contact')}}<span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title font-regular">
                                {{translate('messages.upload')}} {{translate('messages.photo')}} {{translate('messages.cover')}} <span class="text-danger">({{translate('messages.ratio')}} 2:1)</span>
                            </h5>
                        </div>
                        <div class="card-body d-flex flex-column pt-0">
                            <center class="my-auto py-4 py-xl-5">
