                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        ...
                        <div class="order-invoice-right mt-3 mt-sm-0">
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                <h6 class="text-capitalize" >
                                    {{translate('messages.method')}} {{translate('messages.payment')}} :
                                ...
                                @if ($order->order_attachment)
                                    ...
                                    <button class="btn w-100 p-0"  data-toggle="modal" data-target="#imagemodal" title="{{translate('messages.attachment')}} {{translate('messages.order')}}">
                        ...
                        <div class="row justify-content-md-end mb-3 mx-0 mt-4">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right">
                                    <dt class="col-6">{{translate('messages.price')}} {{translate('messages.items')}}:</dt>
                                    <dd class="col-6">{{\App\CentralLogics\Helpers::format_currency($product_price)}}</dd>
                                    @if ($order->store->module->module_type == 'food')
                                    <dt class="col-6">{{translate('messages.cost')}} {{translate('messages.addon')}}:</dt>
                                    ...
                                    <dt class="col-6">{{translate('messages.fee')}} {{translate('messages.delivery')}}:</dt>
                                    <dd class="col-6">
