                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{translate('messages.details')}} {{translate('messages.order')}}</li>
                        </ol>
                    </nav>
                        ...
                        <div class="row">
                            <div class="col-12 pb-2 border-bottom d-flex justify-content-between">
                                <h4 class="card-header-title">
                                    {{translate('messages.details')}} {{translate('messages.order')}}
                                    <span
                        ...
                        <div class="row">
                            <div class="col-6 pt-2">
                                <h6 style="color: #8a8a8a;">
                                    {{translate('messages.note')}} {{translate('messages.order')}} : {{$order['order_note']}}
                                </h6>
                                @if ($order->order_attachment)
                                    <h5 class="text-dark">
                                        {{translate('messages.prescription')}}:
                                    </h5>
                                    <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal" title="{{translate('messages.attachment')}} {{translate('messages.order')}}">
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">
                                        {{translate('messages.method')}} {{translate('messages.payment')}} : {{str_replace('_',' ',$order['payment_method'])}}
                                    </h6>
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{translate('messages.type')}} {{translate('messages.order')}}
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    <dt class="col-sm-6">{{translate('messages.price')}} {{translate('messages.items')}}:</dt>
                                    <dd class="col-sm-6">{{\App\CentralLogics\Helpers::format_currency($product_price)}}</dd>
                                    <dt class="col-sm-6">{{translate('messages.cost')}} {{translate('messages.addon')}}:</dt>
                                    <dd class="col-sm-6">
                                    ...
                                    <dt class="col-sm-6">{{translate('messages.fee')}} {{translate('messages.delivery')}}:</dt>
                                    <dd class="col-sm-6">
                ...
                <div class="card mb-2">
                    ...
                    @if($order->delivery_man)
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>{{translate('messages.info')}} {{translate('messages.contact')}}</h5>
                        </div>
                    ...
                    @if($order->customer)
                        <div class="card-body">
                            ...
                            @if($order->delivery_address)
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5>{{translate('messages.info')}} {{translate('messages.delivery')}}</h5>
                                    @if(isset($address))
