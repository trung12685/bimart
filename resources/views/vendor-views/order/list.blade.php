    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title text-capitalize">
                ...
                <span>
                    {{translate('messages.orders')}} {{str_replace('_',' ',$status)}}
                        ...
                        @foreach($orders as $key=>$order)
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td>
                                    ...
                                    @else
                                        <label
                                            class="badge badge-danger">{{translate('messages.data')}} {{translate('messages.customer')}} {{translate('messages.invalid')}}</label>
                                    @endif
                                </td>
                                <td>
