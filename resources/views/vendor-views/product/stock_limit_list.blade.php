        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a href="{{route('vendor.item.add-new')}}" class="btn btn--primary m-0 pull-right h--37px d-flex align-items-center justify-content-center"><i class="tio-add-circle"></i> {{translate('messages.add')}} {{translate('messages.item')}}</a>
                </div>
