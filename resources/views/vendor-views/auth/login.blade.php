    ...
    <div class="auth-wrapper vendor-login">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <h2 class="title"><span class="d-block">{{translate('All Service')}}</span> <strong class="text--039D55">{{translate('in one field')}}....</strong></h2>
            </div>
        </div>
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                <div class="auth-header">
                    <div class="mb-5">
                        <h2 class="title signin-txt">{{translate('messages.sign_in')}} {{translate('messages.store')}}</h2>
                        <p class="mb-0">{{translate('messages.want_to_login_your_admin_account')}}
                            <a href="{{route('admin.auth.login')}}"><br>
...
<script>
    ...
    $('#owner_sign_in').on('click', function(){
        ...
        $('.signin-txt').text("{{translate('messages.sign_in')}} {{translate('owner')}} {{translate('messages.store')}}")
    });
    $('#employee_sign_in').on('click', function(){
        ...
        $('#owner_sign_in').hide();
        $('#vendor_login_form').hide();
        $('.signin-txt').text("{{translate('messages.sign_in')}} {{translate('employee')}} {{translate('messages.store')}}")
    });
