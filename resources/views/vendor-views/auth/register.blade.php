            ...
            <div class="row">
                <div class="card shadow-sm col-12">
                    <form class="card-body" action="{{ route('restaurant.store')}}" method="post" enctype="multipart/form-data"
                        class="js-validate">
                        @csrf
                        <small class="nav-subtitle">{{translate('messages.store')}} {{translate('messages.info')}}</small>
                        <br>
                        ...
                        <br>
                        <small class="nav-subtitle">{{translate('messages.owner')}} {{translate('messages.info')}}</small>
                        <div class="row row-margin-top">
                        ...
                        <br>
                        <small class="nav-subtitle">{{translate('messages.login')}} {{translate('messages.info')}}</small>
                        <div class="row mt-3">
