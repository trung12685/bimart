                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="text-center">
                            <span class="mb-3">{{translate('messages.info')}} {{translate('messages.store')}}</span>
                            @if($campaign->store)
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        <th class="px-4 border-0 w--120px">
                                            <h4 class="m-0">{{translate('messages.description')}}</h4>
                                        </th>
                                        <th class="px-4 border-0 w--120px">
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="border-0">{{translate('messages.status')}} {{translate('messages.payment')}}</th>
                        <th class="border-0">{{translate('messages.total')}}</th>
                        <th class="border-0">{{translate('messages.status')}} {{translate('messages.order')}}</th>
                    </tr>
                    </thead>
