                    ...
                    <div class="row g-3">
                        <div class="col-lg-6">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        <label class="input-label text-capitalize" for="title">{{translate('messages.daily')}} {{translate('messages.time')}} {{translate('messages.start')}}</label>
                                        <input type="time" id="start_time" class="form-control" name="start_time">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div>
                                        <label class="input-label text-capitalize" for="title">{{translate('messages.daily')}} {{translate('messages.time')}} {{translate('messages.end')}}</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0 h-100 d-flex flex-column">
                                <label>
                                    {{translate('messages.image')}} {{translate('messages.campaign')}}
