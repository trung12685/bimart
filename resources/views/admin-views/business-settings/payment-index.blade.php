    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="page-header-title">
                    ...
                    <span>
                        {{translate('messages.setup')}} {{translate('messages.gateway')}} {{translate('messages.payment')}} 
                    </span>
                </h1>
            </div>
        </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <form action="{{route('admin.business-settings.payment-method-update',['digital_payment'])}}"
                              method="post">
                            @csrf
                            <h5 class="text-capitalize mb-3">{{translate('messages.payment')}} {{translate('messages.digital')}}</h5>
                            <div class="d-flex flex-wrap p-0">
                                <label class="form-check form--check mr-2 mr-md-4">
        ...
        <div class="row digital_payment_methods mt-3 g-3">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('vnpay'))
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['vnpay']):'javascript:'}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                        <h5 class="d-flex flex-wrap justify-content-between">
                            <strong>{{translate('messages.vnpay')}}</strong>
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{asset('/public/assets/admin/img/payment/vnpay.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Base URL" name="vnp_Url"
                                           value="{{env('APP_MODE')!='demo'?$config['vnp_Url']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="API URL" name="vnp_apiUrl"
                                           value="{{env('APP_MODE')!='demo'?$config['vnp_apiUrl']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Website Id" name="vnp_TmnCode"
                                           value="{{env('APP_MODE')!='demo'?$config['vnp_TmnCode']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Security Key" name="vnp_HashSecret"
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('nganluong'))
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['nganluong']):'javascript:'}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                        <h5 class="d-flex flex-wrap justify-content-between">
                            <strong>{{translate('messages.nganluong')}}</strong>
                            <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                <span class="mr-2 switch--custom-label-text text-primary on text-uppercase">{{translate('messages.on')}}</span>
                                <span class="mr-2 switch--custom-label-text off text-uppercase">{{translate('messages.off')}}</span>
                                <input type="checkbox" class="toggle-switch-input" name="status" value="1" {{$config?($config['status']==1?'checked':''):''}}>
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{asset('/public/assets/admin/img/payment/ngan-luong.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="URL API" name="url_api"
                                           value="{{env('APP_MODE')!='demo'?$config['url_api']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Receiver Email" name="receiver_email"
                                           value="{{env('APP_MODE')!='demo'?$config['receiver_email']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Merchant ID" name="merchant_id"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_id']:''}}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Merchant Pass" name="merchant_pass"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_pass']:''}}">
                            </div>
                            <div class="btn--container justify-content-end">
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}" class="btn h--37px btn--primary">{{translate('messages.save')}}</button>
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-2">
                                    <label
                                       >{{translate('messages.password')}} {{translate('messages.store')}}</label><br>
