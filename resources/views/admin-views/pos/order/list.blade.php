    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                <h1 class="page-header-title text-capitalize">{{translate('messages.orders')}} {{translate('messages.pos')}} <span
                        ...
                        <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <span
                                        class="dropdown-header">{{translate('messages.options')}} {{translate('messages.download')}}</span>
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span
                                                    class="mr-2 text-capitalize">{{translate('messages.status')}} {{translate('messages.payment')}}</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2">{{translate('messages.type')}} {{translate('messages.order')}}</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2">{{__('messages.type')}} {{__('messages.order')}}</span>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{translate('messages.status')}} {{translate('messages.payment')}}</th>
                        <th>{{translate('messages.total')}}</th>
                        <th>{{translate('messages.status')}} {{translate('messages.order')}}</th>
                        <th>{{translate('messages.type')}} {{translate('messages.order')}}</th>
