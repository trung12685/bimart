            ...
            <form action="{{route('admin.module.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="{{$lang != $default_lang ? 'd-none':''}} lang_form p-1 mb-2" id="{{$lang}}-form">
                    <div class="form-group">
                        <label class="input-label text-capitalize" for="exampleFormControlInput1">{{translate('messages.name')}} {{translate('messages.module')}} ({{strtoupper($lang)}})</label>
                ...
                @else
                <div class="form-group">
                    <label class="input-label" for="exampleFormControlInput1">{{translate('messages.name')}} {{translate('messages.module')}}</label>
