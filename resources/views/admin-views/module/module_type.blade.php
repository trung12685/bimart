...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('messages.type')}} {{translate('messages.module')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="card">
            <div class="card-header"><h5>{{translate('messages.add')}} {{translate('messages.module')}}</h5></div>
            <div class="card-body">
        ...
        <div class="card mt-3">
            <div class="card-header pb-0">
                <h5>{{translate('messages.list')}} {{translate('messages.module_type')}}</h5>
                {{--<form id="dataSearch">
                    @csrf
                    <!-- Search -->
