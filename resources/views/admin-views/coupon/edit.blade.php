    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.update')}} {{translate('messages.coupon')}}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
            ...
            <div class="card-body">
                <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="date_to">{{translate('messages.date')}} {{translate('messages.expire')}}</label>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="discount_type">{{translate('messages.type')}} {{translate('messages.discount')}}</label>
