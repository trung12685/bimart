                    ...
                    <div class="card-body">
                        <form action="{{route('admin.coupon.store')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-3 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label" for="max_discount">{{translate('messages.discount')}} {{translate('messages.max')}}</label>
                    ...
                    <div class="table-responsive datatable-custom" id="table-div">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th class="border-0">{{translate('messages.purchase')}} {{translate('messages.min')}}</th>
                                <th class="border-0">{{translate('messages.discount')}} {{translate('messages.max')}}</th>
                                <th class="border-0">{{translate('messages.discount')}}</th>
                                <th class="border-0">{{translate('messages.type')}} {{translate('messages.discount')}}</th>
                                <th class="border-0">{{translate('messages.date')}} {{translate('messages.start')}}</th>
                                <th class="border-0">{{translate('messages.date')}} {{translate('messages.expire')}}</th>
