...
@section('content')
                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        <div class="order-invoice-left d-flex d-sm-block justify-content-between">
                            <div>
                                ...
                                @if (!$parcel_order)
                                    <h6 class="mt-2 pt-1 mb-2">
                                        ...
                                        {{translate('messages.store')}} : <span
                                            class="badge badge-soft-primary">{{ Str::limit($order->store ? $order->store->name : translate('messages.store deleted!'), 125, '...')}}</span>
                                    </h6>
                                @endif
                                ...
                                @if ($order['order_note'])
                                    <h6>
                                        {{translate('messages.note')}} {{translate('messages.order')}} :
                                        {{ $order['order_note'] }}
                                    </h6>
                                @endif
                            </div>
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                <h6 class="">
                                    @if ($order['transaction_reference'] == null)
                                        {{translate('messages.code')}} {{translate('messages.reference')}} :
                                ...
                                <h6 class="text-capitalize">{{translate('messages.type')}} {{translate('messages.order')}}
                                ...
                                @if ($order->order_attachment)
                                    ...
                                    <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                        title="{{translate('messages.attachment')}} {{translate('messages.order')}}">
                                                                        ...
                                                                        @foreach (json_decode($detail['variation'], true)[0] as $key1 => $variation)
                                                                            @if ($key1 != 'stock' || ($order->store && config('module.'.$order->store->module->module_type)['stock']))
                                                                                <div class="font-size-sm text-body">
                                                                                    ...
                                                                                    <span
                                                                                        class="font-weight-bold">{{ Str::limit($variation, 115, '...')}}</span>
                                                                                </div>
                                                                            @endif
                                                                        @endforeach
                                                                    @endif
                                                    ...
                                                    <td>
                                                        <div class="media media--sm">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <strong
                                                                        class="line--limit-1">{{ Str::limit($detail->campaign['name'], 120, '...')}}</strong>
                                                                        ...
                                                                        @foreach (json_decode($detail['variation'], true)[0] as $key1 => $variation)
                                                                            @if ($key1 != 'stock' || ($order->store && config('module.'.$order->store->module->module_type)['stock']))
                                                                                <div class="font-size-sm text-body">
                                                                                    ...
                                                                                    <span class="font-weight-bold">{{ Str::limit($variation, 115, '...')}}</span>
                                                                                </div>
                                                                            @endif
                                                                        @endforeach
                                                                    @endif
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5>{{translate('messages.location')}} {{translate('messages.last')}}</h5>
                                </div>
                                @if (isset($address))
                                    <span class="d-block">
                                        <a target="_blank"
                        ...
                        @if ($order->customer)
                            ...
                            @if ($order->receiver_details)
                                ...
                                <h5 class="card-title mt-3">
                                    ...
                                    <span>{{translate('messages.info')}} {{translate('messages.receiver')}}</span>
                                </h5>
                        ...
                        @if ($order->delivery_address)
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">
                                    ...
                                    <span>{{translate('messages.info')}} {{translate($parcel_order ? 'messages.sender' : 'messages.delivery')}}
                                        </span>
                                </h5>
                                @if ($order->order_status != 'delivered')
                            ...
                            @if (isset($address))
                                <div class="delivery--information-single mt-3">
                                    ...
                                    <span class="name">{{translate('Floor')}}</span> <span
                                        class="info">{{ isset($address['floor']) ? $address['floor'] : 'Chưa rõ' }}</span>
                                    <span class="name">{{translate('Road')}}</span> <span
                                        class="info">{{ isset($address['road']) ? $address['road'] : 'Chưa rõ' }}</span>
                                    <span class="name">{{translate('House')}}</span> <span
                                        class="info">{{ isset($address['house']) ? $address['house'] : 'Chưa rõ' }}</span>
                                    <hr class="w-100">
                                    <div>
    ...
    <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="mySmallModalLabel">{{translate('messages.add')}} {{translate('messages.code')}} {{translate('messages.reference')}}</h5>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">{{translate('messages.assign')}} {{translate('messages.deliveryman')}}</h4>
    ...
    <div class="modal fade" id="locationModal" tabindex="-1" role="dialog" aria-labelledby="locationModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="locationModalLabel">{{translate('messages.data')}} {{translate('messages.location')}}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
