            ...
            <div class="row align-items-center">
                <div class="col-xl-10 col-md-9 col-sm-8 mb-3 mb-sm-0 {{$parcel_order ? 'mb-2':''}}">
                    <h1 class="page-header-title text-capitalize m-0">
                        ...
                        <span>
                            @if ($parcel_order) {{translate('messages.orders')}} {{translate('messages.parcel')}} @else {{translate(str_replace('_',' ',$status))}} {{translate('messages.orders')}} @endif <span class="badge badge-soft-dark ml-2">{{$total}}</span>
                        </span>
                    </h1>
                </div>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="text-center border-0">{{translate('messages.status')}} {{translate('messages.order')}}</th>
