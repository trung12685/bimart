...
<main id="content" role="main" class="main pointer-event">
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-4">
                @if($order->customer)
                    <strong class="float-right">Mã đơn hàng : {{$order['id']}}</strong><br>
                    <strong class="float-right">Tên khách hàng
                        : {{$order->customer['f_name'].' '.$order->customer['l_name']}}</strong><br>
                    <strong class="float-right">Điện thoại
                        : {{$order->customer['phone']}}</strong><br>
                    <strong class="float-right">Địa chỉ
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    <h6 class="text-capitalize">
                                        Phương thức thanh toán : {{str_replace('_',' ',$order['payment_method'])}}
                                    </h6>
                                    <h6>
                                        ...
                                        @else
                                            Mã giới thiệu : {{$order['__action_reference']}}
                                        @endif
                                    </h6>
                                    <h6 class="text-capitalize">Loại đơn hàng
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-md-0">
                                                ...
                                                @foreach(json_decode($detail['add_on_ids'],true) as $key2 =>$id)
                                                    ...
                                                    @if($key2==0)<strong><u>Bổ sung : </u></strong>@endif
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    <dt class="col-sm-6">Giá sản phẩm:</dt>
                                    ...
                                    <dt class="col-sm-6">Phí bổ sung:</dt>
                                    <dd class="col-sm-6">
