                ...
                <div class="row g-3">
                            ...
                            <form action="{{route('admin.report.set-date')}}" method="post">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center mb-2">
                                    <h5 class="form-label m-0 mb-2 mr-2">
                                        {{translate('messages.show')}} {{translate('messages.data')}} {{translate('messages.byn')}} {{translate('messages.range')}} {{translate('messages.date')}}
                    ...
                    <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-1">
                            ...
                            <span class="subtitle">{{translate('messages.earned')}} {{translate('messages.admin')}}</span>
                    ...
                    <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-2">
                            ...
                            <span class="subtitle">{{translate('messages.earned')}} {{translate('messages.store')}}</span>
                    ...
                    <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-3">
                            ...
                            <span class="subtitle">{{translate('messages.fee')}} {{translate('messages.delivery')}} {{translate('messages.earned')}}</span>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{translate('messages.id')}} {{translate('messages.order')}}</th>
                                ...
                                <th class="border-0">{{translate('messages.fee')}} {{translate('messages.delivery')}}</th>
