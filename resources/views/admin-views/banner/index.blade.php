    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.add')}} {{translate('messages.banner')}}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
                        ...
                        <form action="{{route('admin.banner.store')}}" method="post" id="banner_form">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.banner')}}</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        <label class="mt-auto mb-0 d-block text-center">{{translate('messages.image')}} {{translate('messages.campaign')}} <small class="text-danger">* ( {{translate('messages.ratio')}} 3:1 )</small></label>
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                {{translate('messages.list')}} {{translate('messages.banner')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$banners->count()}}</span>
                            </h5>
