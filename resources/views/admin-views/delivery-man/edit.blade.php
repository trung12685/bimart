                    ...
                    <div class="row g-4">
                        <div class="col-lg-8">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.deliveryman')}}</label>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label>{{translate('messages.image')}} {{translate('messages.deliveryman')}} <small class="text-danger">* ( {{translate('messages.ratio')}} 1:1 )</small></label>
                        ...
                        <div class="col-lg-4">
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.identity')}}</label>
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option
                                                ...
                                                {{translate('messages.license')}} {{translate('messages.driving')}}
                                            </option>
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.number')}} {{translate('messages.identity')}}</label>
                        ...
                        <div class="col-lg-8">
                            <div class="row g-3">
                                <div class="col-md-6 pb-0">
                                    <div class="row g-2">
                                        <div class="col-12 pb-0">
                                            <div class="form-group mb-0">
                                                <label class="input-label" for="exampleFormControlInput1">{{translate('messages.images')}} {{translate('messages.identity')}} : </label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <label class="input-label" for="exampleFormControlInput1">{{translate('messages.update')}} {{translate('messages.image')}} {{translate('messages.identity')}}</label>
                                    <div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <span>
                            {{translate('messages.information')}} {{translate('messages.account')}}
                        </span>
                    </h5>
                </div>
                <div class="card-body">
