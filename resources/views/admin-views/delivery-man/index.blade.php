    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title text-break">
                ...
                <span>{{translate('messages.add')}} {{translate('messages.deliveryman')}}</span>
            </h1>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label class="text-center">{{translate('messages.image')}} {{translate('messages.deliveryman')}} <small class="text-danger">* ( {{translate('messages.ratio')}} 1:1 )</small></label>
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option value="driving_license">{{translate('messages.license')}} {{translate('messages.driving')}}</option>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label class="form-label" for="exampleFormControlInput1">{{translate('messages.image')}} {{translate('messages.identity')}}</label>
                                <div>
