    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.add')}} {{translate('messages.sub_category')}}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
                ...
                @endif
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlSelect1">{{translate('messages.category')}} {{translate('messages.main')}}
        ...
        <div class="card mt-2">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper">
                    <h5 class="card-title">{{translate('messages.list')}} {{translate('messages.sub_category')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$categories->total()}}</span></h5>
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 w--1">{{translate('messages.category')}} {{translate('messages.main')}}</th>
