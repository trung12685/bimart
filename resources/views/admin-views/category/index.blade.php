        ...
        <div class="card mt-3">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper">
                    <h5 class="card-title">{{translate('messages.list')}} {{translate('messages.category')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$categories->total()}}</span></h5>
                    <div class="min--240">
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 w--1 min-width-200px">{{translate('messages.name')}}</th>
                                <th class="border-0 text-center min-width-200px">{{translate('messages.module')}}</th>
