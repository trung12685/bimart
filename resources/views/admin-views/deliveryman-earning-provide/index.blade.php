...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('messages.provide')}} {{translate('messages.earning')}} {{translate('messages.deliverymen')}}
            </span>
        </h1>
    </div>
    <!-- Page Heading -->
                ...
                <div class="card-header py-2 border-0">
                    <div class="search--button-wrapper">
                        <h5 class="card-title">
                            ...
                            <span>
                                {{translate('messages.table')}} {{translate('messages.deliverymen_earning_provide')}}
                            </span>
