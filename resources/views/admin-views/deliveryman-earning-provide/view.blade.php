...
<div class="content container-fluid">
    ...
    <div class="d-sm-flex row align-items-center justify-content-between mb-2">
        <div class="col-md-6"> 
             <h4 class=" mb-0 text-black-50">{{translate('messages.earning')}} {{translate('messages.deliverymen')}} {{translate('messages.provide')}} {{translate('messages.information')}}</h4>
        </div>
    </div>
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="h3 mb-0  ">{{translate('messages.info')}} {{$account_transaction->restaurant?translate('messages.store'):translate('messages.deliveryman')}}</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="h3 mb-0  ">{{translate('messages.information')}} {{translate('messages.transaction')}} </h3>
                </div>
                <div class="card-body">
