    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3">
                ...
                <span>
                     {{__('messages.report')}} {{__('messages.customer_loyalty_point')}}
                </span>
            </h1>
        </div>
        <!-- Page Header -->
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h4 class="card-title">
                    ...
                    <span>{{__('messages.options')}} {{__('messages.filter')}}</span>
                </h4>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{__('messages.id')}} {{__('messages.transaction')}}</th>
