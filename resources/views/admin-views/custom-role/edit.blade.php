...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('messages.Role')}} {{translate('messages.employee')}}
            </span>
        </h1>
    </div>
    <!-- Page Heading -->
                        ...
                        <div class="check--item-wrapper">
                            ...
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="notification">{{translate('messages.notification')}} {{translate('messages.push')}} </label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                            ...
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="settings">{{translate('messages.settings')}} {{translate('messages.business')}}</label>
                                </div>
                            </div>
                            ...
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="withdraw_list">{{translate('messages.withdraws')}} {{translate('messages.store')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
