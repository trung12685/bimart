                ...
                <form class="" action="{{route('admin.auth.login')}}" method="post" id="form-id">
                    ...
                    <div class="auth-header">
                        <div class="mb-5">
                            ...
                            <p class="mb-0">{{translate('messages.want')}} {{translate('messages.login')}} {{translate('messages.stores')}} {{translate('messages.your')}} ?
                                <a href="{{route('vendor.auth.login')}}">
                                    {{translate('messages.login')}} {{translate('messages.store')}}
                                </a>
                            </p>
                    ...
                    <div class="js-form-message form-group">
                        <label class="input-label text-capitalize" for="signinSrEmail">{{translate('messages.email')}} {{translate('messages.your')}}</label>
