        ...
        <div class="tab-pane fade show active" id="vendor">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        <i class="tio-info"></i>
                        <span>{{translate('messages.info')}} {{translate('messages.discount')}}</span>
                    </h5>
                ...
                <div class="card-body">
                    ...
                    <div class="row gy-3">
                            ...
                            <div class="discount-item">
                                ...
                                <ul class="list-unstyled list-unstyled-py-3 text-dark">
                                    <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                        <span>{{translate('messages.date')}} {{translate('messages.start')}} :</span>
                                    ...
                                    <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                        <span>{{translate('messages.date')}} {{translate('messages.end')}} :</span>
                        ...
                        <div class="col-md-4 text-center text-md-left">
                            ...
                            <ul class="list-unstyled list-unstyled-py-3 text-dark">
                                <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                    <span>{{translate('messages.discount')}} {{translate('messages.max')}} :</span>
                                    <strong>{{\App\CentralLogics\Helpers::format_currency($store->discount?$store->discount->max_discount:0)}}</strong>
                                </li>
                                <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                    <span>{{translate('messages.purchase')}} {{translate('messages.min')}} :</span>
      ...
      <div class="modal-body pb-4 pt-4">
        <form action="{{route('admin.vendor.discount',[$store['id']])}}" method="post" id="discount-form">
            ...
            <div class="row gx-2">
                ...
                <div class="col-md-4 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{translate('messages.purchase')}} {{translate('messages.min')}} ({{\App\CentralLogics\Helpers::currency_symbol()}})</label>
                ...
                <div class="col-md-4 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{translate('messages.discount')}} {{translate('messages.max')}} ({{\App\CentralLogics\Helpers::currency_symbol()}})</label>
            ...
            <div class="row gx-2">
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{translate('messages.date')}} {{translate('messages.start')}}</label>
                ...
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{translate('messages.date')}} {{translate('messages.end')}}</label>
                ...
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        <label class="input-label" for="title">{{translate('messages.time')}} {{translate('messages.start')}}</label>
                ...
                <div class="col-md-6 col-6">
                    <label class="input-label" for="title">{{translate('messages.time')}} {{translate('messages.end')}}</label>
