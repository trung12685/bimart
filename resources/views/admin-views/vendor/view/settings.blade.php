            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <span>{{translate('messages.settings')}} {{translate('messages.store')}}</span>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.scheduled')}} {{translate('messages.order')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this status is turned on, the customer is able to place a scheduled
                        ...
                        <form action="{{route('admin.vendor.update-settings',[$store['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    <label class="input-label text-capitalize">{{translate('messages.amount')}} {{translate('messages.order')}} {{translate('messages.minimum')}}</label>
