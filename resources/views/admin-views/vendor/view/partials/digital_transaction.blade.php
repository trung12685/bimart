        ...
        <table id="datatable"
            ...
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="w--1 border-0">{{translate('messages.id')}} {{translate('messages.order')}}</th>
                    <th class="w--2 border-0">{{translate('messages.total_order_amount')}}</th>
                    <th class="w--3 border-0">{{translate('messages.earned')}} {{translate('messages.store')}}</th>
                    <th class="w--1 border-0">{{translate('messages.earned')}} {{translate('messages.admin')}}</th>
                    <th class="w--1 border-0">{{translate('messages.fee')}} {{translate('messages.delivery')}}</th>
