                            ...
                            <div class="row g-3 mb-0">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="name">{{translate('messages.name')}} {{translate('messages.store')}}</label>
                                        <input type="text" name="name" class="form-control" placeholder="{{translate('messages.name')}} {{translate('messages.store')}}"
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="address">{{translate('messages.address')}} {{translate('messages.store')}}</label>
                                        <textarea  type="text" name="address" class="form-control h--45px" placeholder="{{translate('messages.address')}} {{translate('messages.store')}}"
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        <label class="input-label mb-0">{{translate('messages.logo')}} {{translate('messages.store')}}<small class="text-danger"> ( {{translate('messages.ratio')}} 1:1 )</small></label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        <label class="input-label mb-0">{{translate('messages.upload')}} {{translate('messages.photo')}} {{translate('messages.cover')}} <span class="text-danger">({{translate('messages.ratio')}} 2:1)</span></label>
                                        <center class="py-4 my-auto">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                ...
                                <span>{{translate('messages.information')}} {{translate('messages.owner')}}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="f_name" class="form-control" placeholder="{{translate('messages.first_name')}}" value="{{$store->vendor->f_name}}"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <span class="card-header-icon mr-2"><i class="tio-user"></i></span>
                                <span>{{translate('messages.information')}} {{translate('messages.account')}}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
