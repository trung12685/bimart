                            ...
                            <div class="row g-3 mb-0">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="{{translate('messages.name')}} {{translate('messages.store')}}" value="{{old('name')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" name="address" class="form-control h--45px" placeholder="{{translate('messages.address')}} {{translate('messages.store')}}" required >{{old('address')}}</textarea>
                                    </div>
                                </div>
                            </div>
