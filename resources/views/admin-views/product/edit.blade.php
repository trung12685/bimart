            ...
            <div class="row g-2">
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <label class="input-label" for="exampleFormControlInput1">{{translate('messages.images')}} {{translate('messages.item')}}</label>
                            <div>
                            ...
                            <label class="text-dark mt-3">{{translate('messages.thumbnail')}} {{translate('messages.item')}} <small class="text-danger">* ( {{translate('messages.ratio')}} 1:1 )</small></label>
