            ...
            <div class="row align-items-center g-2">
                <div class="col-md-6 col-12">
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{translate('messages.list')}} {{translate('messages.item')}} <span class="badge badge-soft-dark ml-2" id="foodCount">{{$items->total()}}</span>
                        </span>
                    </h1>
                </div>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('admin.item.view',[$item['id']])}}">
                                    ...
                                    <div class="media-body">
                                        <h5 class="text-hover-primary mb-0 max-width-200px word-break line--limit-2">{{Str::limit($item['name'],200,'...')}}</h5>
                                    </div>
                                </a>
                            </td>
                            <td>
                            {{Str::limit($item->category?$item->category->name:translate('messages.category_deleted'),200,'...')}}
                            </td>
                            <td class="max-width-150px line--limit-2">
                            {{Str::limit($item->store?$item->store->name:translate('messages.store deleted!'), 200, '...')}}
                            </td>
                            <td>
