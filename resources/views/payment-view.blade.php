...
<head>
    <meta charset="utf-8">
    <title>
        @yield('title'){{translate('messages.digital payment')}} - BiMart
    </title>
    <!-- SEO Meta Tags-->
                ...
                <div class="row">
                    ...
                    @if($config['status'])
                        <div class="col-md-6 mb-4 cursor-pointer">
                            <div class="card">
                                <div class="card-body pt-2 h--70px">
                                    <button class="btn btn-block click-if-alone mt--n-11" onclick="location.href='{{route('vnpay-payment')}}'">
                                        <img width="150" src="{{asset('public/assets/admin/img/vnpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4 cursor-pointer">
                            <div class="card">
                                <div class="card-body" style="padding-top:1px;padding-bottom:1px;">
                                    <form  method="POST" 
                                        action="{{route('nganluong-index')}}">
                                        {{ csrf_field() }}
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="150"
                                                src="{{asset('public/assets/admin/img/ngan-luong.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
