            ...
            <div class="row" style="line-height:2.5rem">
                <div class="card shadow-sm col-12">
                    <form class="card-body" action="{{ route('deliveryman.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <small class="nav-subtitle">{{translate('messages.info')}} {{translate('messages.deliveryman')}}</small>
                        <br>
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6 col-lg-3 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.deliveryman')}}
                                        </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{translate('messages.type')}} {{translate('messages.identity')}}
                                        </label>
                                    <select name="identity_type" class="form-control">
                                        <option value="passport">{{translate('messages.passport')}}</option>
                                        <option value="driving_license">{{translate('messages.license')}} {{translate('messages.driving')}}
                                            </option>
                                        <option value="nid">{{translate('messages.nid')}}</option>
                                        <option value="restaurant_id">{{translate('messages.id')}} {{translate('messages.store')}}
                                            </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{translate('messages.number')}} {{translate('messages.identity')}}
                                        </label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{translate('messages.image')}} {{translate('messages.identity')}}
                                        </label>
                                    <div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <label  class="input-label">{{translate('messages.image')}} {{translate('messages.deliveryman')}}<small
                                    ...
                                    <center class="pt-4">
                                        <img class="img--200 border rounded" id="viewer" width="100px"
                        ...
                        <small class="nav-subtitle text-capitalize">{{translate('messages.info')}} {{translate('messages.login')}}</small>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" name="tel" id="phone" placeholder="{{translate('messages.Ex:')}} 0912345***"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="form-control" placeholder="{{translate('messages.Ex:')}} 12345678"
                                        value="{{ old('password')}}" required>
                                </div>
                            </div>
                        </div>
                        </center><button type="submit" style="margin-top:10px;" class="btn btn-primary float-right">{{translate('messages.submit')}}</button>
                    </form>
                </div>
            </div>
        </div>
