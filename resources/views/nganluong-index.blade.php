...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>
        Chọn phương thức thanh toán BIMART
    </title>
                                ...
                                <div class="list-method list-mb8 list-last-mb accordion" id="accordionList">
                                        <!--Check QR Support-->
                                            <div class="list-method-item">
                                                <button type="submit" value="ATM_ONLINE-EXB" id="VINGANLUONG" name="paymethod" class="list-method-button">
                                                    <div class="row row-16 align-items-center">
                                                        <div class="col">
                                                            <div class="title h3 color-default">
                                                                Ứng dụng hỗ trợ thanh toán QR
                                                                <span class="vnpay-logo b">
                                                                    <span class="vnpay-red">Ngân</span><span class="vnpay-blue">Lượng</span>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="icon">
                                                                <img src="{{asset('public/assets/dulieuchung/qrcode.png')}}" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </button>
                                                            ...
                                                            <div class="list-mb24 list-last-mb">
                                                                ...
                                                                <div class="list-bank-main">
                                                                    <div class="row row-8 list-mb8 list-crop">
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang vietcombank vcb">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang vietinbank vib icb">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang agribank nong nghiep nn">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang sacombank scb">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngân hàng techcombank tcb">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang dong a da">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngân hàng tmcp sài gòn - hà nội sh">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang eximbank exb">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang oceanbank dai duong">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang namabank nab">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngan hang bacabank bab">
                                                                            ...
                                                                            <div class="col-item col-sm-3 col-4 domestic-bank" search-value="ngân hàng vietabank vab">
                                        ...
                                        <!--Check E-wallet support-->
                                            <div class="list-method-item">
                                                <button type="submit" value="NL-VI" id="VINGANLUONG" name="paymethod" class="list-method-button">
                                                    <div class="row row-16 align-items-center">
                                                        <div class="col">
                                                            <div class="title h3 color-default">
Ví điện tử                                                                    <span class="vnpay-logo b">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="icon">
                                                                <img src="{{asset('public/assets/dulieuchung/vinganluong.png')}}" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </button>
        ...
        <div class="section">
            <div class="row row-32 list-mb24 list-crop align-items-center justify-content-center">
                <div class="col fz-h5 show-mobile">
                    Phát triển bởi BIMART © 2022
                </div>
                <div class="col-sm show-desktop">
                    <div class="row row-32 align-items-center">
                        <div class="col-auto">
                            <!-- button.button -->
                            <a href="tel:0947369356" class="ubg-ghost ubox-size-button-default ubg-hover ubg-active ubtn">
                                <div class="ubtn-inner">
                                    ...
                                    <span class="ubtn-text h3 color-info u pl12">0947.369.356</span>
                                </div>
                            </a>
                            <!-- end button.button -->
                        </div>
                        <div class="col-auto">
                            <!-- button.button -->
                            <a href="mailto:hotro@bimart.vn" class="ubg-ghost ubox-size-button-default ubg-hover ubg-active ubtn">
                                <div class="ubtn-inner">
                                    <div class="ubg-line-porcelain-dark ubox-size-ic-md ubox-square ubox ubox-ic">
                                        <img src="{{asset('public/assets/dulieuchung/24x24-email.svg')}}" alt="" class="ic-default">
                                    </div>
                                    <span class="ubtn-text h3 color-info u pl12">hotro@bimart.vn</span>
                                </div>
                            </a>
                            <!-- end button.button -->
                        </div>
    ...
    <div class="chat-box show-desktop">
        <div class="chat-box-icon">
            <a href="https://zalo.me/0914849539" target="_blank">
            ...
            <div class="row row-32 align-items-center">
                ...
                <div class="col-auto">
                    <div class="row row-0">
                        ...
                        <div class="col-auto">
                            <!-- button.button -->
                            <a href="mailto:hotro@bimart.vn" class="ubg-transparent ubox-size-button-default ubox-square ubg-hover ubg-active ubtn">
                                <div class="ubtn-inner">
                                    <span class="ubtn-ic ubtn-ic-left">
