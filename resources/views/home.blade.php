                ...
                <div class="col-lg-6 col-md-6 col-sm-12 about-us-right-column">
                    <div class="about-us__right animate__animated animate__backInRight">
                        ...
                        <p class="about-us-text">
                            {!! \Illuminate\Support\Str::limit(\App\CentralLogics\Helpers::get_settings('about_us'), 505) !!}
                        </p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 mb-5 stuning-feature">
                        <div class="service-left animate__animated animate__backInLeft">
                            ...
                            <p class="stuning-p">
                                {{ isset($landing_page_text['feature_section_description']) ? $landing_page_text['feature_section_description'] : '111Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ex odio,  turpis accumsan congue.' }}
                            </p>
                        </div>
                        ...
                        <div class="search">
                            <form id="newsLetterForm" method="post" action="{{ route('newsletter.subscribe')}}">
                                ...
                                <input type="email" name="email" class="form-control newsletter--input"
                                    placeholder="Nhập email của bạn" value="{{ old('email')}}" required> <br>
